...
Clients attach over a Unix stream socket, or through `howl-session-bridge` over
ordinary SSH stdio. The bridge is protocol-blind: the bytes described here are
identical on the Unix socket and over SSH.
