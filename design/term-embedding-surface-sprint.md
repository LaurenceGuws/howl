...
| Checkpoint 4: terminal reply handoff | ready | Review `vt.pendingOutput()` to session input publication. | Either formalize as term orchestration or move only if a precise VT/session contract exists. |
