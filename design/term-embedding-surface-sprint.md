...
| Checkpoint 5: runtime thread boundary | ready | Decide whether the loop remains `howl-term` orchestration or a session I/O runner with callbacks. | No move unless session can own I/O without importing VT/render concepts. |
