Historical authority: sprint artifact for the 2026-06-13 PTY+VT folder/file owner structure sprint.
...
- Slice 5, `Delete temporary VT terminal wrapper and finalize shallow src layout`: `howl-vt` `4e76640`; root `d1188ad`.
