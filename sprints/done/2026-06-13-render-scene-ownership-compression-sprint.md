Historical authority: sprint artifact for the 2026-06-13 render scene ownership compression sprint.

Why superseded or done: sprint closed after accepted nested render slices `959576d`, `acb929e`, and `27317db`, with root receipts `5bbe0ec`, `007a0ee`, and `701accc`.
...
- Slice 3 is accepted in `howl-render` `27317db`; root receipt pending orchestrator commit.
