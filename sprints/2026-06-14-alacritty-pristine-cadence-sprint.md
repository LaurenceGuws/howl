...
- Sprint seed receipt: Cut 1 committed as `c925170`; Cut 2 committed as `93e9224`, both accepted by reviewer `review-2026-06-14-ascii-rain-performance-01`.
...
- Coder may implement Cut 3: separate runtime admission from runtime drive for terminal surfaces.
- Cut 3 remains inside this sprint section and is the only authorized coder work right now.
