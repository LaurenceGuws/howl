...
- Sprint seed receipt: Cut 1 was seeded, accepted by reviewer `review-2026-06-14-ascii-rain-performance-01`, and committed in `howl-linux-host` as `c925170`.
...
- Coder may implement Cut 2: rebuild frame cadence around one explicit frame owner.
- Cut 2 remains inside this sprint section and is the only authorized coder work right now.
