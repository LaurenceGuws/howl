...
Status: Slice 4 accepted in `howl-vt`; root receipt pending.
...
- Slice 4, `VT protocol bucket removal toward final no-wrapper layout`: `howl-vt` `538a96b`; root receipt pending.
