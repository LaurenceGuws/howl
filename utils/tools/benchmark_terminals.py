...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--howl-bin", type=Path, default=HOWL_HARNESS_DIR / "howl_term_release_fast")
    parser.add_argument("--stress-bin", type=Path, default=STRESS_HARNESS_DIR / "ascii_rain_stress_release_fast")
...
def run_build() -> None:
    subprocess.run(["zig", "build", "--release=fast", "install"], cwd=HOST_ROOT, check=True)
