...
class MainActivity : FlutterActivity() {
    companion object {
        ...
        private const val IME_CHANNEL = "howl.flutter/android_ime"
        private const val HOST_CHANNEL = "howl.flutter/android_host"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        imeChannel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, IME_CHANNEL).also { channel ->
        ...
        hostChannel =
            MethodChannel(flutterEngine.dartExecutor.binaryMessenger, HOST_CHANNEL).also { channel ->
                channel.setMethodCallHandler { call, result ->
                    when (call.method) {
                        "filesPath" -> result.success(filesDir.absolutePath)
                        else -> result.notImplemented()
                    }
                }
            }
