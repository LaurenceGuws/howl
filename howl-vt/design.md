...
- `src/clipboard.zig` owns OSC 52 selection grammar, bounded Base64 codec,
  and child-directed query serialization. `src/consequences.zig` separately
  owns retained occurrence lifetime and ordering.
