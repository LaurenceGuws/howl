...
const welcome = Buffer.from('48574c530a02000000000008000000000000002a', 'hex');
const hello = '48574c530a01000000000000';
...
const interactionVector = Buffer.from('48574c530a0d000000000014010203040506070800001ffd0403ff7f12340300', 'hex');
