...
const welcome = Buffer.from('48574c530902000000000008000000000000002a', 'hex');
const hello = '48574c530901000000000000';
...
function frame(kind, payload) {
  ...
  result.write('HWLS', 0, 'ascii'); result[4] = 9; result[5] = kind;
...
const interactionVector = Buffer.from('48574c53090d000000000014010203040506070800001ffd0403ff7f12340300', 'hex');
