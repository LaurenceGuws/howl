...
pub fn build(b: *std.Build) void {
    ...
    root.export_symbol_names = &.{
        ...
        "hw_terminal_revision", "hw_rows",              "hw_columns",          "hw_history_offset",
        "hw_history_count",     "hw_history_row_base",  "hw_alternate_screen", "hw_leader_present",
        "hw_last_result_code",  "hw_control_ready",     "hw_reset",            "hw_observe",
        "hw_request_image",     "hw_release_image",     "hw_send_text",        "hw_send_paste",
